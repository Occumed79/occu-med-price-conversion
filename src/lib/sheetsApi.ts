...
export async function createSheet(sheet: { name: string; source_currency: string; rows: SheetRow[]; adjustments?: Adjustment[] }): Promise<SavedSheet> {
...
export async function updateSheet(id: string, sheet: { name: string; source_currency: string; rows: SheetRow[]; adjustments?: Adjustment[] }): Promise<SavedSheet> {
